...
def execute_bump_hack(c):
    ...
    if release_type == "none":
        ...
        c.run(
            "git add pyproject.toml {{cookiecutter.project_slug}}/__init__.py docs/conf.py {{cookiecutter.project_slug}}/blog/rss_feed_display.py {{cookiecutter.project_slug}}/blog/daily_scriptures.py",
            pty=True,
        )
...
def lint(c, fix=False):
    ...
    if fix:
        ...
        c.run("flake8 {{cookiecutter.project_slug}}", pty=True)
